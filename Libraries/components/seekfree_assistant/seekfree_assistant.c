...
float                   seekfree_assistant_parameter[SEEKFREE_ASSISTANT_SET_PARAMETR_COUNT];    // 保存接收到的参数
...
{
    fifo_init(&seekfree_assistant_fifo,  seekfree_assistant_buffer, SEEKFREE_ASSISTANT_BUFFER_SIZE);
}
